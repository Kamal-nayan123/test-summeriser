...
// require('env').config(); // Load environment variables from a .env file
// MongoDB connection (replace with your MongoDB connection string)
mongoose.connect("mongodb+srv://kamalnayanchivukula:Premakanth@123@database.ca2mjix.mongodb.net/Text_Summeriser", {
